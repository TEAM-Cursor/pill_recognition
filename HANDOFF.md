...
status: 개발
updated: 2026-06-15
summary: FastAPI+React 스캐폴드 GitHub push 완료(private bestcow/pill_recognition). 남은 건 팀원 아이디 치환·테스트PR·branch protection(웹 수동)
repo: bestcow/pill_recognition
---
...
## 다음 할 일
- **(사람)** 팀원 4명 GitHub 아이디 확정되면 CODEOWNERS의 `@bestcow`를 담당자별로 교체 + 4명 collaborator(write) 추가.
